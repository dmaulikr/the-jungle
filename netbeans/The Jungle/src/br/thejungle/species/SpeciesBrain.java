...
public abstract class SpeciesBrain implements Serializable {
    ...
    /**
     * Gets the number of custom genes this species uses.
     * These genes are automatically combined during reproduction and are accessible by invoking the getCustomGeneticCode() method.
     */
    ...
    /**
     * Returns the current nutrition. This value must maintain the average value of OPTIMUM_NUTRITION
     */
